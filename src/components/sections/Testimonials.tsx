        ...
        <div className="mt-10 grid grid-cols-1 gap-6 md:grid-cols-3">
          {testimonials.map((testimonial) => (
            <figure
              ...
              className="flex flex-col justify-between gap-6 rounded-lg border border-navy/10 bg-white p-6 shadow-sm"
            >
              <blockquote className="text-sm leading-relaxed text-navy/80">
                &ldquo;{testimonial.quote[locale]}&rdquo;
              </blockquote>
              <figcaption className="font-sans text-sm font-bold uppercase tracking-[0.1em] text-blue">
